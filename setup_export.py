...
EXPORT_API = '''from fastapi import APIRouter, Depends, HTTPException
...
with open("services/export_service.py", "w", encoding="utf-8") as f:
    f.write(EXPORT_SERVICE)
print("OK services/export_service.py")

with open("api/export.py", "w", encoding="utf-8") as f:
    f.write(EXPORT_API)
print("OK api/export.py")

with open("main.py", "r", encoding="utf-8") as f:
    s = f.read()

if "api.export" not in s:
    ...
    if old in s:
        ...
        with open("main.py", "w", encoding="utf-8") as f:
            f.write(s)
        print("OK main.py 已挂载导出路由")
    else:
        print("!! main.py 里没找到插入位置，请手动挂载")
else:
    print("SKIP main.py 已含导出路由")